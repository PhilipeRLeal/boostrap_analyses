...
setup(name='boostrap_statistical_analyses',
    ...
    keywords="boostrap, statistics, probability",
    
    description='This is a python package for statistical analyses using bootstrap approach',
    ...
    package_data={'tests/Data_example': ['Data_example*']},
